    ...
    public async Task<IActionResult> Get(CancellationToken cancellationToken)
    {
        ...
        return Ok(new
        {
            ...
            features = new
            {
                ...
                uploadDocuments = new { enabled = true, note = "Left-nav Upload Documents page. Manage Documents + Upload redirects there. Uploaders upload to assigned organization(s); staff pick the client. CR08 — new files auto-assign Assigned to the org primary Assigned technician, else the first Assigned tech, else stay unassigned and visible to staff. Viewers are read-only." },
