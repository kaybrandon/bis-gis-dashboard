    ...
    public async Task<IActionResult> Get(CancellationToken cancellationToken)
    {
        ...
        return Ok(new
        {
            ...
            features = new
            {
                ...
                uploaderRole = new { enabled = true, note = "QC04 — Uploader sees Viewer-accessible pages, uploads to assigned org(s) only, and posts client-visible Comments. No Internal Notes, doc editing, tech assignment, or user management. Dashboard Assignee is hidden." },
