...
export const DOCUMENTS_BY_TECHNICIAN_HELP =
  'Technician is the document Assigned to, not the organization’s Assigned technician. Unassigned is work with no assignee. Counts are documents created or uploaded in the selected date range. Click a bar to open that queue.'
